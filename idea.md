...
seriousran
seriousran
Merge branch 'master' of https://github.com/seriousran/awesome-video-sum
27b783b
·
6 years ago
.gitattributes
...
6 years ago
.gitignore
add .gitignore to remove .ipynb_checkpoint
6 years ago
LICENSE.md
Create LICENSE.md
6 years ago
...
Contributing
CC0-1.0 license
Awesome Video Summarization Awesome

A curated list of the Video Summarization subject in computer science toward using machine learning and deep learning
동영상 자동 요약에 관한 큐레이션 - 머신러닝과 딥러닝 단계까지
关于自动视频摘要的管理 - 使用机器学习和深度学习
Contents
...
Using video skimming
Scene change detection (=Video Transition Detection)
Codes
...
Chopra, Sumit, Raia Hadsell, and Yann LeCun, "Learning a similarity metric discriminatively, with application to face verification," Computer Vision and Pattern Recognition, CVPR 2005.
...
To the extent possible under law, Chanran Kim has waived all copyright and related or neighboring rights to this work.
About

A curated list of the Video Summarization subject which is a computer science using machine learning and deep learning

Topics
awesome video deep-learning video-summarization awesome-list cvpr video-sum extracting-key-frames
Resources
Readme
License
CC0-1.0 license
